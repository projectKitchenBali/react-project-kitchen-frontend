...
const mapDispatchToProps = (dispatch: Dispatch<AnyAction>) => ({
    ...
    onSubmitForm: (user: TCurrentUser) => dispatch({type: SETTINGS_SAVED, payload: agent.Auth.save(user)}),
            ...
            <div className="container page">
                <div className="row">
                    <div className="col-md-6 offset-md-3 col-xs-12">
                        <h2 className="text-xs-center m-b-3 text_type_main-h2">Ваши настройки</h2>
                        <ListErrors errors={props.errors}></ListErrors>
                        <SettingsForm currentUser={props.currentUser} onSubmitForm={props.onSubmitForm}/>
                        <hr className={cl.hr}/>
                        <a href="#" className={`${cl.logout} text_type_main-default`} onClick={props.onClickLogout}>
                            Выйти из аккаунта
                        </a>
                    </div>
                </div>
